...
local specWarnViolentWhirlwind				= mod:NewSpecialWarningRun(388046, "Melee", nil, nil, 4, 2, nil, nil, "justrun")
local specWarnRottenMeatYou					= mod:NewSpecialWarningRun(384974, nil, nil, nil, 4, 2, nil, nil, "justrun")
local specWarnViciousClawmangle				= mod:NewSpecialWarningRun(367484, nil, nil, nil, 4, 2, nil, nil, "justrun")
local specWarnRagestorm						= mod:NewSpecialWarningRun(382555, "Melee", nil, nil, 4, 2, nil, nil, "justrun")
local specWarnRagestormDispel				= mod:NewSpecialWarningDispel(382555, "RemoveEnrage", nil, nil, 1, 2, nil, nil, "enrage")
local specWarnBloodyRage					= mod:NewSpecialWarningDispel(385827, "RemoveEnrage", nil, nil, 1, 2, nil, nil, "enrage")
local specWarnWitheringPoison				= mod:NewSpecialWarningDispel(385058, "RemovePoison", nil, nil, 1, 2, nil, nil, "helpdispel")
local specWarnRottenMeat					= mod:NewSpecialWarningDispel(384974, "RemovePoison", nil, nil, 1, 2, nil, nil, "helpdispel")
local specWarnWithering						= mod:NewSpecialWarningDispel(368081, false, nil, nil, 1, 2, nil, nil, "helpdispel")
local specWarnWitheringContagion			= mod:NewSpecialWarningMoveAway(383087, nil, nil, nil, 1, 2, nil, nil, "range5")
local specWarnStinkBreath					= mod:NewSpecialWarningDodge(388060, nil, nil, nil, 2, 2, nil, nil, "breathsoon")
local specWarnToxicTrap						= mod:NewSpecialWarningDodge(368287, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnRottingSurge					= mod:NewSpecialWarningDodge(383385, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnStomp							= mod:NewSpecialWarningDodge(373943, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnBloodthirstyCharge			= mod:NewSpecialWarningDodge(385832, nil, nil, nil, 2, 2, nil, nil, "chargemove")
local specWarnSummontotem					= mod:NewSpecialWarningSwitch(374057, "Dps", nil, nil, 1, 2, nil, nil, "attacktotem")
local specWarnRotchantingTotem				= mod:NewSpecialWarningSwitch(382435, "Dps", nil, nil, 1, 2, nil, nil, "attacktotem")
local yellWitheringContagion				= mod:NewYell(383087)
local specWarnWitheringBurst				= mod:NewSpecialWarningYou(367503, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local yellWitheringBurst					= mod:NewYell(367503)
local specWarnBurstofDecay					= mod:NewSpecialWarningInterrupt(374544, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnHidiousCackle					= mod:NewSpecialWarningInterrupt(367500, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--46?
local specWarnDecaySurge					= mod:NewSpecialWarningInterrupt(382474, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnScreech						= mod:NewSpecialWarningInterrupt(385029, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnNecroticBreath				= mod:NewSpecialWarningSpell(382712, nil, nil, nil, 2, 2, nil, nil, "breathsoon")--26.7-40?
local specWarnGTFO							= mod:NewSpecialWarningGTFO(383399, nil, nil, nil, 1, 8, nil, nil, "watchfeet")
