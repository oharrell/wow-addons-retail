...
local specWarnRejuvSerumDispel			= mod:NewSpecialWarningDispel(155498, "MagicDispeller", nil, 2, 1, 2, nil, nil, "dispelboss")
local specWarnDebilitatingRay			= mod:NewSpecialWarningInterrupt(155505, "HasInterrupt", nil, 2, 1, 2, nil, nil, "kickcast")
local specWarnSummonBlackIronDread		= mod:NewSpecialWarningInterrupt(169088, "HasInterrupt", nil, 2, 1, 2, nil, nil, "kickcast")
local specWarnSummonBlackIronVet		= mod:NewSpecialWarningInterrupt(169151, "HasInterrupt", nil, 2, 1, 2, nil, nil, "kickcast")
local specWarnVeilofShadow				= mod:NewSpecialWarningInterrupt(155586, "HasInterrupt", nil, 2, 1, 2, nil, nil, "kickcast")--Challenge mode only(little spammy for mage, "kickcast")
local specWarnVeilofShadowDispel		= mod:NewSpecialWarningDispel(155586, "RemoveCurse", nil, 2, 1, 2, nil, nil, "helpdispel")
local specWarnShadowBoltVolley			= mod:NewSpecialWarningInterrupt(155588, "HasInterrupt", nil, 2, 1, 2, nil, nil, "kickcast")
local specWarnSmash						= mod:NewSpecialWarningDodge(155572, "Tank", nil, nil, 1, 2, nil, nil, "shockwave")
local specWarnFranticMauling			= mod:NewSpecialWarningDodge(154039, "Tank", nil, nil, 1, 2, nil, nil, "shockwave")
local specWarnEruption					= mod:NewSpecialWarningDodge(155037, "Tank", nil, nil, 1, 2, nil, nil, "shockwave")
