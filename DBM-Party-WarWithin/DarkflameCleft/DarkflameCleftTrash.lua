...
local specWarnMassiveStomp					= mod:NewSpecialWarningSpell(1218117, nil, nil, nil, 2, 2, nil, nil, "carefly")
local specWarnWildWallop					= mod:NewSpecialWarningDodge(423501, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnCeaselessFlame				= mod:NewSpecialWarningDodge(426261, nil, nil, nil, 2, 15, nil, nil, "frontal")
local yellCeaselessFlame					= mod:NewYell(426261)
--local specWarnShadowSmash					= mod:NewSpecialWarningDodge(422414, nil, nil, nil, 2, 15)
local specWarnSurgingFlame					= mod:NewSpecialWarningDodge(440652, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnBurningCandles				= mod:NewSpecialWarningDodge(1218131, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnPyroPummel					= mod:NewSpecialWarningDodge(426260, nil, nil, nil, 2, 15, nil, nil, "frontal")--Not CD based, conditional based, so no NP timer
local specWarnOHHeadlock					= mod:NewSpecialWarningYou(426619, nil, nil, nil, 1, 2, nil, nil, "targetyou")
--local specWarnStormshield					= mod:NewSpecialWarningDispel(386223, "MagicDispeller", nil, nil, 1, 2)
local specWarnMoleFrenzy					= mod:NewSpecialWarningInterrupt(425536, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Prio Interrupt
local specWarnFlamingTether					= mod:NewSpecialWarningInterrupt(426295, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Prio Interrupt
local specWarnExplosiveFlame				= mod:NewSpecialWarningInterrupt(424322, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Prio Interrupt
local specwarnWicklighterBolt				= mod:NewSpecialWarningInterrupt(423479, false, nil, nil, 1, 2, nil, nil, "kickcast")--Spammed ability, so off by default
local specWarnFlamebolt						= mod:NewSpecialWarningInterrupt(428563, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--Spammed ability, so off by default
local specWarnDrainLight					= mod:NewSpecialWarningInterrupt(422541, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Prio Interrupt
local specwarnFlashpoint					= mod:NewSpecialWarningDispel(428019, "RemoveMagic", nil, nil, 1, 2, nil, nil, "dispelnow")
local specwarnPanicked						= mod:NewSpecialWarningDispel(424650, "RemoveEnrage", nil, nil, 1, 2, nil, nil, "enrage")
