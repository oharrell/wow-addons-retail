...
local specWarnGorgingSmash					= mod:NewSpecialWarningSpell(426893, nil, nil, nil, 2, 2, nil, nil, "aesoon")
local specErraticRitual						= mod:NewSpecialWarningSpell(1221532, nil, nil, nil, 2, 2, nil, nil, "aesoon")
local specWarnStingingSandstorm				= mod:NewSpecialWarningSpell(1237220, nil, nil, nil, 2, 2, nil, nil, "aesoon")
local specWarnConsumeSpirit					= mod:NewSpecialWarningSwitch(1226306, "-Healer", nil, nil, 1, 2, nil, nil, "killmob")
local specWarnGluttonousMiasma				= mod:NewSpecialWarningMoveAway(1221190, nil, nil, nil, 2, 2, nil, nil, "scatter")
local specWarnVolatileEjection				= mod:NewSpecialWarningYou(1226111, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local yellVolatileEjection					= mod:NewShortYell(1226111)
local specWarnVolatileEjectionOther			= mod:NewSpecialWarningTarget(1226111, nil, nil, nil, 2, 2, nil, nil, "frontal")
local specWarnWarp							= mod:NewSpecialWarningDodge(1222356, nil, nil, nil, 2, 2, nil, nil, "farfromline")
local specWarnBurrowingEruption				= mod:NewSpecialWarningDodge(1223007, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnBurrowCharge					= mod:NewSpecialWarningDodge(1237195, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnEarthCrusher					= mod:NewSpecialWarningDodge(1215850, nil, nil, nil, 2, 2, nil, nil, "aesoon")
local specWarnArcingEnergy					= mod:NewSpecialWarningMoveAway(1221483, nil, nil, nil, 1, 2, nil, nil, "range5")
local yellArcingEnergy						= mod:NewShortYell(1221483)
local specWarnGorge							= mod:NewSpecialWarningInterrupt(1229474, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--More or less spammed so no timer
local specWarnArcingZap						= mod:NewSpecialWarningInterrupt(1229510, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--Important
local specWarnArcaneBolt					= mod:NewSpecialWarningInterrupt(1222815, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--More or less spammed so no timer
local specWarnHungeringRage					= mod:NewSpecialWarningDispel(1221133, "RemoveEnrage", nil, nil, 1, 2, nil, nil, "enrage")--No clear CD, probably only cast once at a health threshold
local specWarnArcingEnergyDispel			= mod:NewSpecialWarningDispel(1221483, "RemoveMagic", nil, nil, 1, 2, nil, nil, "dispelnow")
local specWarnEmbraceOfKaresh				= mod:NewSpecialWarningDispel(1223000, "MagicDispeller", nil, nil, 1, 2, nil, nil, "dispelnow")
