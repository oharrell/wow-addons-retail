...
local specWarnZepBarrage					= mod:NewSpecialWarningDodge(1213704, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnFlamethrower					= mod:NewSpecialWarningDodge(465754, nil, nil, nil, 2, 15, nil, nil, "frontal")
local specWarnShreddation					= mod:NewSpecialWarningDodge(474337, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnRPGG							= mod:NewSpecialWarningDodge(1216039, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnSurpriseInspection			= mod:NewSpecialWarningDodge(465682, nil, nil, nil, 2, 15, nil, nil, "frontal")
...
local specwarnPlantSeaBombs					= mod:NewSpecialWarningDodge(468726, nil, nil, nil, 2, 2, nil, nil, "watchstep")--Not enough data to add timers
local specWarnSparkslam						= mod:NewSpecialWarningDefensive(465666, nil, nil, nil, 1, 2, nil, nil, "defensive")
...
local specWarnSurveyingBeamFailure			= mod:NewSpecialWarningRun(462771, nil, nil, nil, 4, 2, nil, nil, "laserrun")
--local yellChainLightning					= mod:NewYell(387127)
local specWarnOverchargeDispel				= mod:NewSpecialWarningDispel(469799, "RemoveMagic", nil, nil, 1, 2, nil, nil, "helpdispel")
local specWarnBloodthirstyCackle			= mod:NewSpecialWarningDispel(463058, "RemoveEnrage", nil, nil, 1, 2, nil, nil, "enrage")
local specWarnBloodthirstyCackleKick		= mod:NewSpecialWarningInterrupt(463058, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnSurveyingBeam					= mod:NewSpecialWarningInterrupt(462771, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnTrickShot						= mod:NewSpecialWarningInterrupt(1214468, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnRestorativeAlgae				= mod:NewSpecialWarningInterrupt(471733, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnHarpoon						= mod:NewSpecialWarningInterrupt(468631, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
