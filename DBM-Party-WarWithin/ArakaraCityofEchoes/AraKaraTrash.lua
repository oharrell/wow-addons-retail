...
local specWarnMassiveSlam					= mod:NewSpecialWarningSpell(434252, nil, nil, nil, 2, 2, nil, nil, "stunsoon")
local specWarnLocusSwarm					= mod:NewSpecialWarningSpell(1241693, nil, nil, nil, 2, 2, nil, nil, "aesoon")
local specWarnWebSpray						= mod:NewSpecialWarningDodge(434824, nil, nil, nil, 2, 15, nil, nil, "frontal")
local specWarnImpale						= mod:NewSpecialWarningDodge(453161, nil, nil, nil, 2, 15, nil, nil, "frontal")
local specWarnEruptingWebs					= mod:NewSpecialWarningDodge(433845, nil, nil, nil, 2, 2, nil, nil, "watchstep")
--local yellChainLightning					= mod:NewYell(387127)
local specWarnExtractionStrike				= mod:NewSpecialWarningDefensive(433002, nil, nil, nil, 1, 2, nil, nil, "defensive")
--local specWarnStormshield					= mod:NewSpecialWarningDispel(386223, "MagicDispeller", nil, nil, 1, 2)
local specWarnHorrifyingShrill				= mod:NewSpecialWarningInterrupt(434802, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Prio
local specWarnResonantBarrage				= mod:NewSpecialWarningInterrupt(434793, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Prio
local specWarnPoisonBolt					= mod:NewSpecialWarningInterrupt(436322, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Prio (no CD timer, it's recast out of spell lockout regardless
local specWarnRevoltingVolley				= mod:NewSpecialWarningInterrupt(448248, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnVenomVolley					= mod:NewSpecialWarningInterrupt(433841, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Prio
