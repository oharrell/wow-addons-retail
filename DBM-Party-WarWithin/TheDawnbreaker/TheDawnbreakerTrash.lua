...
local specWarnShadowyDecay					= mod:NewSpecialWarningSpell(451102, nil, nil, nil, 2, 2, nil, nil, "aesoon")
local specWarnDarkOrb						= mod:NewSpecialWarningSpell(450854, nil, nil, nil, 2, 2, nil, nil, "watchorb")
local specWarnBlackEdge						= mod:NewSpecialWarningDodge(431494, nil, nil, nil, 2, 15, nil, nil, "frontal")
local specWarnBlackHail						= mod:NewSpecialWarningDodge(432565, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnTerrifyingSlam				= mod:NewSpecialWarningRun(451117, nil, nil, nil, 4, 2, nil, nil, "justrun")
local specWarnTackyNova						= mod:NewSpecialWarningRun(451098, nil, nil, nil, 4, 2, nil, nil, "justrun")
local specWarnTormentingEruption			= mod:NewSpecialWarningMoveAway(431349, "Melee", nil, nil, 4, 2, nil, nil, "scatter")
local specWarnSygianSeed					= mod:NewSpecialWarningMoveAway(432448, nil, nil, nil, 1, 2, nil, nil, "runout")
local yellStygianSeed						= mod:NewShortYell(432448)
local yellStygianSeedFades					= mod:NewShortFadesYell(432448)
local specWarnBurstingCacoon				= mod:NewSpecialWarningMoveAway(451107, nil, nil, nil, 1, 2, nil, nil, "runout")
local yellBurstingCacoon					= mod:NewShortYell(451107)
local yellBurstingCacoonFades				= mod:NewShortFadesYell(451107)
local specWarnSilkenShell					= mod:NewSpecialWarningInterrupt(451097, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High prio interrupt
local specWarnTormentingRay					= mod:NewSpecialWarningInterrupt(431364, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High prio?
local specWarnTormentingBeam				= mod:NewSpecialWarningInterrupt(431333, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High prio
local specWarnAbyssalHowl					= mod:NewSpecialWarningInterrupt(450756, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High prio
local specWarnSilkenShellDispel				= mod:NewSpecialWarningDispel(451097, "MagicDispeller", nil, nil, 1, 2, nil, nil, "helpdispel")
local specWarnTacticiansRageDispel			= mod:NewSpecialWarningDispel(451112, "RemoveEnrage", nil, nil, 1, 2, nil, nil, "enrage")
