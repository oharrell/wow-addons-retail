...
local specWarnUmbralWind				= mod:NewSpecialWarningSpell(451939, nil, nil, nil, 2, 2, nil, nil, "carefly")
local specWarnAscension					= mod:NewSpecialWarningDodge(451387, nil, nil, nil, 2, 2, nil, nil, "aesoon")
local specWarnObsidianStomp				= mod:NewSpecialWarningDodge(456696, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnShadowlavaBlast			= mod:NewSpecialWarningDodge(456711, nil, nil, nil, 2, 15, nil, nil, "frontal")
local specWarnDarkEruption				= mod:NewSpecialWarningMoveAway(456713, nil, nil, nil, 2, 2, nil, nil, "range5")
local specWarnDecapitate				= mod:NewSpecialWarningDodge(451067, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnMindPiercer				= mod:NewSpecialWarningDodge(451391, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnBlazingShadowflame		= mod:NewSpecialWarningDodge(462216, nil, nil, nil, 2, 15, nil, nil, "frontal")
local specWarnTwilightFlames			= mod:NewSpecialWarningMoveAway(451612, nil, nil, nil, 2, 2, nil, nil, "runout")
local specWarnLavaFist					= mod:NewSpecialWarningDefensive(451971, nil, nil, nil, 2, 2, nil, nil, "defensive")--12.8
local specWarnShadowFlameSlash			= mod:NewSpecialWarningDefensive(451241, nil, nil, nil, 2, 2, nil, nil, "defensive")
local specWarnCorrupt					= mod:NewSpecialWarningDefensive(451395, nil, nil, nil, 2, 2, nil, nil, "defensive")
local yellTwilightFlames				= mod:NewShortYell(451612)
local yellTwilightFlamesFades			= mod:NewShortFadesYell(451612)
local specWarnRecklessTacticDispel		= mod:NewSpecialWarningDispel(451379, "RemoveEnrage", nil, nil, 1, 2, nil, nil, "enrage")
local specWarnEnvelopingShadowflame		= mod:NewSpecialWarningDispel(451224, "RemoveCurse", nil, nil, 1, 2, nil, nil, "helpdispel")
local specWarnMassTremor				= mod:NewSpecialWarningInterrupt(451871, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Prio
local specWarnSearMind					= mod:NewSpecialWarningInterrupt(76711, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Prio
local specWarnGTFO						= mod:NewSpecialWarningGTFO(451614, nil, nil, nil, 1, 8, nil, nil, "watchfeet")
