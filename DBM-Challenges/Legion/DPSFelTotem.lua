...
if DBM:IsRestricted() then
	...
	--local specWarnCharge			= mod:NewSpecialWarningYou(100, nil, nil, nil, 1, 2, nil, nil, "chargemove")
	...
	--local timerEarthquakeCD		= mod:NewCDCountTimer(0, 237950, nil, nil, nil, 2)
	--local timerFelSurgeCD			= mod:NewCDCountTimer(0, 242496, nil, nil, nil, 3)
	--local timerFelRuptureCD		= mod:NewCDCountTimer(0, 241664, nil, nil, nil, 3)
	--local timerFelBurstCD			= mod:NewCDCountTimer(0, 242733, nil, nil, nil, 3)
	local badStateDetected = false
	local function setFallback(self, dontSetAlerts)
		if not dontSetAlerts then
			--specWarnSonicScream:SetAlert(0, "stopcast", 2)
			--specWarnEarthquake:SetAlert(0, "aesoon", 2)
			--specWarnCharge:SetAlert(0, "chargemove", 2)
			--specWarnFelSurge:SetAlert(0, "stunsoon", 2)
			--specWarnFelBurst:SetAlert(0, "crowdcontrol", 2)
		end
		local onlyColor = not DBM.Options.HideDBMBars and not badStateDetected
		--timerEarthquakeCD:SetTimeline(0, onlyColor)
		--timerFelSurgeCD:SetTimeline(0, onlyColor)
		--timerFelRuptureCD:SetTimeline(0, onlyColor)
		--timerFelBurstCD:SetTimeline(0, onlyColor)
	end
