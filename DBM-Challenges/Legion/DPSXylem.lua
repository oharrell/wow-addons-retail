...
if DBM:IsRestricted() then
	...
	local function setFallback(self, dontSetAlerts)
		if not dontSetAlerts then
			--specWarnRazorIce:SetAlert(0, "watchstep", 2)
			--specWarnArcaneAnnihilation:SetAlert(0, "kickcast", 2)
			--specWarnShadowBarrage:SetAlert(0, "watchorb", 2)
			--specWarnDrawPower:SetAlert(0, "kickcast", 2)
			--specWarnSeeds:SetAlert(0, "runout", 2)
		end
		local onlyColor = not DBM.Options.HideDBMBars and not badStateDetected
		--timerRazorIceCD:SetTimeline(0, onlyColor)
		--timerArcaneAnnihilationCD:SetTimeline(0, onlyColor)
		--timerArcaneAnnihilation:SetTimeline(0, onlyColor)
		--timerShadowBarrageCD:SetTimeline(0, onlyColor)
		--timerDrawPowerCD:SetTimeline(0, onlyColor)
		--timerSeedsCD:SetTimeline(0, onlyColor)
		--timerDarknessWithin:SetTimeline(0, onlyColor)
	end
