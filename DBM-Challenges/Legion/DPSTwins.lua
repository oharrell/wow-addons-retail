...
if DBM:IsRestricted() then
	...
	local function setFallback(self, dontSetAlerts)
		if not dontSetAlerts then
			--specWarnFixate:SetAlert(0, "justrun", 2)
			--specWarnGrasp:SetAlert(0, "kickcast", 2)
			--specWarnRift:SetAlert(0, "killmob", 2)
			--specWarnRune:SetAlert(0, "getinyellowrunes", 2)
		end
		local onlyColor = not DBM.Options.HideDBMBars and not badStateDetected
		--timerRisingDragonCD:SetTimeline(0, onlyColor)
		--timerHandCD:SetTimeline(0, onlyColor)
		--timerGraspCD:SetTimeline(0, onlyColor)
		--timerRuneCD:SetTimeline(0, onlyColor)
	end
