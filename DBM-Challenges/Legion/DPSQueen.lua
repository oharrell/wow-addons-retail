...
if DBM:IsRestricted() then
	...
	local function setFallback(self, dontSetAlerts)
		if not dontSetAlerts then
			--specWarnThrowSpear:SetAlert(0, "watchstep", 2)
			--specWarnBloodFather:SetAlert(0, "crowdcontrol", 2)
			--specWarnDarkWings:SetAlert(0, "stilldanger", 2)
			--specWarnBerserkersRage:SetAlert(0, "justrun", 2)
			--specWarnBladeStorm:SetAlert(0, "justrun", 2)
			--specWarnRunicDetonation:SetAlert(0, "getinyellowrunes", 2)
			--specWarnKnowledge:SetAlert(0, "targetchange", 2)
		end
		local onlyColor = not DBM.Options.HideDBMBars and not badStateDetected
		--timerThrowSpearCD:SetTimeline(0, onlyColor)
		--timerBloodFatherCD:SetTimeline(0, onlyColor)
		--timerDarkWingsCD:SetTimeline(0, onlyColor)
		--timerBerserkersRageCD:SetTimeline(0, onlyColor)
		--timerBladeStormCD:SetTimeline(0, onlyColor)
		--timerRunicDetonationCD:SetTimeline(0, onlyColor)
		--timerKnowledgeCD:SetTimeline(0, onlyColor)
	end
