...
if DBM:IsRestricted() then
	...
	local specWarnWailofMourning		= mod:NewSpecialWarningSpell(271561, "Healer", nil, nil, 2, 2, nil, nil, "aesoon")
	local specWarnSupressionSlam		= mod:NewSpecialWarningDodge(270003, nil, nil, 2, 2, 2, nil, nil, "shockwave")
	local specWarnPurificationStrike	= mod:NewSpecialWarningDodge(270293, "Melee", nil, nil, 1, 2, nil, nil, "watchstep")
	local specWarnPurificationBeam		= mod:NewSpecialWarningDodge(270284, nil, nil, nil, 2, 8, nil, nil, "behindmob")
	local specWarnGroundCrush			= mod:NewSpecialWarningDodge(270514, nil, nil, nil, 2, 2, nil, nil, "watchstep")
	local specWarnDarkShot				= mod:NewSpecialWarningDodge(270930, nil, nil, nil, 2, 2, nil, nil, "watchstep")
	local specWarnDeathlyChill			= mod:NewSpecialWarningInterrupt(269973, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
	local specWarnShadowBolt			= mod:NewSpecialWarningInterrupt(270923, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
	local specWarnInduceRegeneration	= mod:NewSpecialWarningInterrupt(270901, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
	local specWarnHex					= mod:NewSpecialWarningInterrupt(270492, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
	local specWarnBladestorm			= mod:NewSpecialWarningRun(270927, nil, nil, nil, 4, 2, nil, nil, "justrun")
	local specWarnChannelLighting		= mod:NewSpecialWarningRun(270889, nil, nil, nil, 4, 2, nil, nil, "justrun")
	local specWarnSeduction				= mod:NewSpecialWarningDispel(270920, "RemoveMagic", nil, 2, 1, 2, nil, nil, "helpdispel")
	local specWarnAncestralFury			= mod:NewSpecialWarningDispel(269976, "RemoveEnrage", nil, 2, 1, 2, nil, nil, "helpdispel")
	local specWarnHiddenBladeDispel		= mod:NewSpecialWarningDispel(270865, "RemovePoison", nil, nil, 1, 2, nil, nil, "helpdispel")
	local specWarnHuntingLeap			= mod:NewSpecialWarningYou(270500, nil, nil, nil, 1, 2, nil, nil, "runaway")
	...
	local specWarnDarkRevelation		= mod:NewSpecialWarningMoveAway(271640, nil, nil, nil, 1, 2, nil, nil, "runout")
	local yellDarkRevelation			= mod:NewYell(271640)
	local yellDarkRevelationFades		= mod:NewShortFadesYell(271640)
	local specWarnPoisonBarrage			= mod:NewSpecialWarningMoveAway(270507, nil, nil, nil, 1, 2, nil, nil, "runout")
	local yellPoisonBarrage				= mod:NewYell(270507)
	local yellPoisonBarrageFades		= mod:NewShortFadesYell(270507)
	local specWarnFixate				= mod:NewSpecialWarningRun(269936, nil, nil, nil, 4, 2, nil, nil, "justrun")
	local yellFixate					= mod:NewYell(269936, nil, false)
	local specWarnHiddenBlade			= mod:NewSpecialWarningMoveAway(270865, nil, nil, nil, 1, 2, nil, nil, "runout")
	local specWarnHealingTideTotem		= mod:NewSpecialWarningSwitch(143474, "-Healer", nil, nil, 1, 2, nil, nil, "attacktotem")
