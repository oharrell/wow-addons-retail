...
local specWarnMegaDrill				= mod:NewSpecialWarningSpell(1215409, nil, nil, nil, 2, 2, nil, nil, "aesoon")--Waste Processing Unit (294324 old version) (S2 confirmed, "aesoon")
local specWarnProcessWaste			= mod:NewSpecialWarningSpell(294290, nil, nil, nil, 1, 15, nil, nil, "frontal")--Waste Processing Unit
local specWarnShockCoil				= mod:NewSpecialWarningSpell(300207, nil, nil, nil, 2, 2, nil, nil, "aesoon")--Weaponized Crawler
local specWarnShortOut				= mod:NewSpecialWarningSpell(297128, nil, nil, nil, 2, 2, nil, nil, "aesoon")--(S2 confirmed, "aesoon")
local specWarnSlimewave				= mod:NewSpecialWarningDodge(300777, nil, nil, nil, 2, 2, nil, nil, "chargemove")--Slime Elemental
local specWarnScrapCannon			= mod:NewSpecialWarningDodge(300188, nil, nil, nil, 2, 15, nil, nil, "frontal")--Weaponized Crawler
local yellScrapCannon				= mod:NewYell(300188)--Weaponized Crawler
local specWarnBORK					= mod:NewSpecialWarningDodge(299475, nil, nil, nil, 2, 15, nil, nil, "frontal")--Scraphound
local yellBORK						= mod:NewYell(299475)--Scraphound
local specWarnShockwave				= mod:NewSpecialWarningDodge(300424, nil, nil, nil, 2, 15, nil, nil, "frontal")--Scrapbone Bully
local specWarnRapidFire				= mod:NewSpecialWarningDodge(301667, nil, nil, nil, 2, 15, nil, nil, "frontal")--Mechagon Cavalry
local specWarnRocketBarrage			= mod:NewSpecialWarningDodge(294103, nil, nil, nil, 2, 2, nil, nil, "watchstep")--Rocket Tonk
local specWarnSonicPulse			= mod:NewSpecialWarningDodge(293986, nil, nil, nil, 2, 2, nil, nil, "farfromline")--Blastatron X-80/Spider Tank (S2 confirmed, "farfromline")
...
local specWarnCapacitorDischarge	= mod:NewSpecialWarningDodge(295169, nil, nil, nil, 3, 2, nil, nil, "watchstep")--Blastatron X-80 (S2 confirmed, "watchstep")
--local specwarnCorrosiveGunk		= mod:NewSpecialWarningMoveTo(1215412, nil, nil, nil, 12, 2)
local specWarnConsume				= mod:NewSpecialWarningRun(300687, nil, nil, nil, 4, 2, nil, nil, "justrun")--Toxic Monstrosity
local specWarnGyroScrap				= mod:NewSpecialWarningRun(300159, "Melee", nil, nil, 4, 2, nil, nil, "justrun")--Heavy Scrapbot
local specWarnShrinkYou				= mod:NewSpecialWarningYou(284219, nil, nil, nil, 1, 2, nil, nil, "targetyou")
...
local specWarnShieldGenerator		= mod:NewSpecialWarningMove(293683, nil, nil, nil, 1, 2, nil, nil, "moveboss")
local specWarnSlimeBolt				= mod:NewSpecialWarningInterrupt(300764, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--Slime Elemental
local specWarnSuffocatingSmog		= mod:NewSpecialWarningInterrupt(300650, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--Toxic Lurker
local specWarnRepairProtocol		= mod:NewSpecialWarningInterrupt(300171, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--Heavy Scrapbot
local specWarnRepair				= mod:NewSpecialWarningInterrupt(300087, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--Pistonhead Mechanic
local specWarnEnrage				= mod:NewSpecialWarningInterrupt(300414, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--Scrapbone Grinder/Scrapbone Bully
local specWarnStoneskin				= mod:NewSpecialWarningInterrupt(300514, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--Scrapbone Shaman
local specWarnGraspingHex			= mod:NewSpecialWarningInterrupt(300436, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--Scrapbone Shaman
local specWarnEnlarge				= mod:NewSpecialWarningInterrupt(301629, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--Mechagon Renormalizer
local specWarnShrink				= mod:NewSpecialWarningInterrupt(284219, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--Mechagon Renormalizer
local specWarnDetonate				= mod:NewSpecialWarningInterrupt(301088, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--Bomb Tonk (High Prio) (S2 confirmed, "kickcast")
local specWarnTuneUp				= mod:NewSpecialWarningInterrupt(293729, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specwarnGigaWallop			= mod:NewSpecialWarningInterrupt(293827, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--No cooldown, so no nampelate timer (S2 confirmed, "kickcast")
local specWarnSuffocatingSmogDispel	= mod:NewSpecialWarningDispel(300650, "RemoveDisease", nil, nil, 1, 2, nil, nil, "helpdispel")--Toxic Lurker
local specWarnOverclockDispel		= mod:NewSpecialWarningDispel(293930, "MagicDispeller", nil, nil, 1, 2, nil, nil, "helpdispel")--Pistonhead Mechanic/Mechagon Mechanic
local specWarnEnlargeDispel			= mod:NewSpecialWarningDispel(301629, "MagicDispeller", nil, nil, 1, 2, nil, nil, "helpdispel")--Mechagon Renormalizer
