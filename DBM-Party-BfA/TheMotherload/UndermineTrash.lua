...
local specWarnForceCannon					= mod:NewSpecialWarningDodge(268865, nil, nil, nil, 2, 2, nil, nil, "shockwave")
local specWarnArtilleryBarrage				= mod:NewSpecialWarningDodge(269090, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnBrainstorm					= mod:NewSpecialWarningDodge(473304, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnMassiveSlam					= mod:NewSpecialWarningDodge(1214754, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnSeekandDestroy				= mod:NewSpecialWarningRun(262377, nil, nil, nil, 4, 2, nil, nil, "justrun")
local specWarnUppercut						= mod:NewSpecialWarningYou(1217280, nil, nil, nil, 1, 2, nil, nil, "carefly")
local yellUppercut							= mod:NewShortYell(1217280)
local specWarnRockLance						= mod:NewSpecialWarningInterrupt(263202, false, nil, nil, 1, 2, nil, nil, "kickcast")--No cooldown, just spell lock. spammed ability
local specWarnIcedSpritzer					= mod:NewSpecialWarningInterrupt(280604, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Prio
local specWarnFuriousQuake					= mod:NewSpecialWarningInterrupt(268702, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Prio
local specWarnTectonicBarrier				= mod:NewSpecialWarningInterrupt(263215, false, nil, nil, 1, 2, nil, nil, "kickcast")--Off by default since furious quake is prio interrupt
local specWarnToxicBlades					= mod:NewSpecialWarningInterrupt(269302, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnTectonicBarrierDispel			= mod:NewSpecialWarningDispel(263215, "MagicDispeller", nil, nil, 1, 2, nil, nil, "helpdispel")
local specWarnEnemyToGoo					= mod:NewSpecialWarningInterrupt(268797, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Prio
