...
local specWarnLeap			= mod:NewSpecialWarningYou(144546, nil, nil, nil, 1, 2, nil, nil, "targetyou")
--local yellLeap				= mod:NewYell(144546)
local specWarnCallPack		= mod:NewSpecialWarning("specWarnCallPack", "Ranged|Tank", nil, nil, 4, 2, nil, nil, nil, nil, "justrun")--Summons add for every person within 40 yards of boss. Ranged should be able to avoid this. Tank in warning to pick ones up spawned by melee
local specWarnTears			= mod:NewSpecialWarningSpell(144702, nil, nil, nil, 2, 2, nil, nil, "aesoon")
local specWarnMoonfangCurse	= mod:NewSpecialWarning("specWarnMoonfangCurse", "Melee", nil, nil, 4, 2, nil, nil, nil, nil, "justrun")
