...
local specWarnGTFO							= mod:NewSpecialWarningGTFO(355581, nil, nil, nil, 1, 8, nil, nil, "watchfeet")
local specWarnTidalStomp					= mod:NewSpecialWarningSpell(355429, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local yellQuickblade						= mod:NewShortYell(355830)
local specWarnDisruptionGrenade				= mod:NewSpecialWarningDodge(355900, nil, nil, nil, 2, 2, nil, nil, "watchstep")--(S3 Valid, "watchstep")
local specWarnRiftBlasts					= mod:NewSpecialWarningDodge(352390, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnLightshardRetreat				= mod:NewSpecialWarningDodge(357197, nil, nil, nil, 2, 2, nil, nil, "watchstep")--(S3 Valid, "watchstep")
local specWarnDriftingStar					= mod:NewSpecialWarningDodge(357226, nil, nil, nil, 2, 2, nil, nil, "watchorb")--(S3 Valid, "watchorb")
local specWarnVolatilePufferfish			= mod:NewSpecialWarningDodge(355234, nil, nil, nil, 2, 2, nil, nil, "watchstep")--(S3 Valid, "watchstep")
local specWarnBoulderThrow					= mod:NewSpecialWarningDodge(355464, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnCrackle						= mod:NewSpecialWarningDodge(355577, nil, nil, nil, 2, 2, nil, nil, "watchstep")--(S3 Valid, "watchstep")
local specWarnTidalBurst					= mod:NewSpecialWarningDodge(1244650, nil, nil, nil, 2, 2, nil, nil, "watchstep")--(S3 Valid, "watchstep")
local specWarnBeamSplicer					= mod:NewSpecialWarningDodge(356001, nil, nil, nil, 2, 2, nil, nil, "watchstep")--(S3 Valid, "watchstep")
local specWarnFrenziedChargeAvoid			= mod:NewSpecialWarningDodge(357512, nil, nil, nil, 2, 2, nil, nil, "chargemove")
local specWarnShockMines					= mod:NewSpecialWarningDodge(355473, nil, nil, nil, 2, 2, nil, nil, "watchstep")--(S3 Valid, "watchstep")
local specWarnWildThrash					= mod:NewSpecialWarningDodge(357508, nil, nil, nil, 2, 2, nil, nil, "watchstep")--(S3 Valid, "watchstep")
local specWarnLavaBreath					= mod:NewSpecialWarningDodge(356404, nil, nil, nil, 2, 15, nil, nil, "frontal")--(S3 Valid, "frontal")
local specWarnEnergizedSlam					= mod:NewSpecialWarningMoveAway(1240821, nil, nil, nil, 2, 2, nil, nil, "runout")--(S3 Valid, "runout", "scatter")
local specWarnChronolightEnhancer			= mod:NewSpecialWarningRun(357229, false, nil, nil, 4, 2, nil, nil, "justrun")--(S3 Valid, "justrun")
local specWarnChargedPulse					= mod:NewSpecialWarningRun(355584, nil, nil, nil, 4, 2, nil, nil, "justrun")--(S3 Valid, "justrun")
local specWarnHyperlightBomb				= mod:NewSpecialWarningMoveAway(357029, nil, nil, nil, 1, 2, nil, nil, "runout")--(S3 Valid, "runout")
local yellHyperlightBomb					= mod:NewShortYell(357029)
local yellHyperlightBombFades				= mod:NewShortFadesYell(357029)
local specWarnLethalForce					= mod:NewSpecialWarningYou(355480, nil, nil, nil, 1, 2, nil, nil, "lineyou")--(S3 Valid, "lineyou")
local specWarnFrenziedCharge				= mod:NewSpecialWarningYou(357512, nil, nil, nil, 1, 17, nil, nil, "lineyou")
local yellFrenziedCharge					= mod:NewShortYell(357512)
local specWarnInvigoratingFishStick			= mod:NewSpecialWarningSwitch(355132, "-Healer", nil, nil, 1, 2, nil, nil, "attacktotem")--(S3 Valid, "attacktotem")
local specWarnWanderingPulsar				= mod:NewSpecialWarningSwitch(357238, "-Healer", nil, nil, 1, 2, nil, nil, "targetchange")
local specWarnShellcrackerDefensive			= mod:NewSpecialWarningDefensive(355048, nil, nil, nil, 1, 2, nil, nil, "defensive")--(S3 Valid, "defensive")
local specWarnHyperlightBackhand			= mod:NewSpecialWarningDefensive(356967, nil, nil, nil, 1, 2, nil, nil, "carefly")--(S3 Valid, "carefly")
local specWarnPowerKick						= mod:NewSpecialWarningDefensive(355477, nil, nil, nil, 1, 2, nil, nil, "carefly")
local specWarnSparkBurn						= mod:NewSpecialWarningInterrupt(355930, false, nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnHardLightBarrier				= mod:NewSpecialWarningInterrupt(355934, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--(S3 Valid, "kickcast")
local specWarnHyperlightBolt				= mod:NewSpecialWarningInterrupt(354297, false, nil, 2, 1, 2, nil, nil, "kickcast")--Spammy if interrupt off CD (S3 Valid, "kickcast")
local specWarnSpamFilter					= mod:NewSpecialWarningInterrupt(347775, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnJunkMail						= mod:NewSpecialWarningInterrupt(347903, false, nil, nil, 1, 2, nil, nil, "kickcast")--spammed, off just in case
local specWarnCryofMrrggllrrgg				= mod:NewSpecialWarningInterrupt(355057, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--(S3 Valid, "kickcast")
local specWarnWaterbolt						= mod:NewSpecialWarningInterrupt(355225, false, nil, nil, 1, 2, nil, nil, "kickcast")--(S3 Valid, "kickcast")
local specWarnUnstableRift					= mod:NewSpecialWarningInterrupt(357260, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnAncientDread					= mod:NewSpecialWarningInterrupt(356407, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnBrackishBolt					= mod:NewSpecialWarningInterrupt(356843, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--(S3 Valid, "kickcast")
local specWarnEmpGlyphofRestraint			= mod:NewSpecialWarningInterrupt(356537, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--(S3 Valid, "kickcast")
local specWarnGlyphofRestraint				= mod:NewSpecialWarningDispel(355915, "RemoveMagic", nil, nil, 1, 2, nil, nil, "helpdispel")--(S3 Valid, "helpdispel")
local specWarnRefractionShield				= mod:NewSpecialWarningDispel(355980, "MagicDispeller", nil, nil, 1, 2, nil, nil, "helpdispel")--(S3 Valid, "helpdispel")
local specWarnAncientDreadDispel			= mod:NewSpecialWarningDispel(356407, "RemoveCurse", nil, nil, 1, 2, nil, nil, "helpdispel")
