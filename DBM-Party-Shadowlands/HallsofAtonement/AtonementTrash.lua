...
local specWarnThrash					= mod:NewSpecialWarningSpell(326409, nil, nil, nil, 2, 2, nil, nil, "aesoon")
local specWarnSinQuake					= mod:NewSpecialWarningDodge(326441, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnDeadlyThrust				= mod:NewSpecialWarningDodge(325523, "Tank", nil, nil, 1, 2, nil, nil, "shockwave")--Removed?
local specWarnPowerfulSwipe				= mod:NewSpecialWarningDodge(326997, nil, nil, nil, 2, 15, nil, nil, "frontal")
local specWarnTurntoStone				= mod:NewSpecialWarningDodge(1235762, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnDisplayOfPower			= mod:NewSpecialWarningMoveAway(1236614, nil, nil, nil, 1, 2, nil, nil, "scatter")--spread alert toward the end of debuff
local specWarnMarkofObliteration		= mod:NewSpecialWarningMoveAway(325876, nil, nil, nil, 1, 2, nil, nil, "runout")--backup if no dispel
local yellMarkofObliterationFades		= mod:NewShortFadesYell(325876)
local specWarnStoneFist					= mod:NewSpecialWarningDefensive(1237071, nil, nil, nil, 2, 2, nil, nil, "carefly")
local specWarnDisruptingScreech			= mod:NewSpecialWarningCast(1235326, "SpellCaster", nil, nil, 2, 2, nil, nil, "stopcast")
local specWarnLoyalBeastsInterrupt		= mod:NewSpecialWarningInterrupt(326450, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnCollectSins				= mod:NewSpecialWarningInterrupt(325700, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnSiphonLife				= mod:NewSpecialWarningInterrupt(325701, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnWickedBolt				= mod:NewSpecialWarningInterrupt(338003, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--No CD, just spammed
local specWarnLoyalBeasts				= mod:NewSpecialWarningDispel(326450, "RemoveEnrage|Tank", nil, nil, 1, 2, nil, nil, "enrage")--Target because it's hybrid warning
local specWarnTurnToStoneDispel			= mod:NewSpecialWarningDispel(1235762, "RemoveMagic", nil, nil, 2, 2, nil, nil, "dispelnow")--326607 old version
local specWarnMarkofObliterationDispel	= mod:NewSpecialWarningDispel(325876, "RemoveMagic", nil, nil, 1, 2, nil, nil, "dispelnow")
