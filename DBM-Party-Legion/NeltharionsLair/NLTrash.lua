...
local specWarnBurningHatred				= mod:NewSpecialWarningRun(200154, nil, nil, nil, 4, 2, nil, nil, "justrun")
local specWarnCrush						= mod:NewSpecialWarningRun(226287, "Melee", nil, nil, 1, 2, nil, nil, "justrun")
local specWarnAvalanche					= mod:NewSpecialWarningDodge(183088, nil, nil, 3, 1, 2, nil, nil, "watchstep")
local specWarnPetrifyingTotem			= mod:NewSpecialWarningDodge(202108, nil, nil, nil, 2, 2, nil, nil, "runaway")
local specWarnPetrifyingCloud			= mod:NewSpecialWarningDispel(186576, "RemoveMagic", nil, nil, 1, 2, nil, nil, "helpdispel")
local specWarnFrenzy					= mod:NewSpecialWarningDispel(201983, "RemoveEnrage", nil, nil, 1, 2, nil, nil, "enrage")
local specWarnStoneGaze					= mod:NewSpecialWarningInterrupt(202181, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnGTFO						= mod:NewSpecialWarningGTFO(186576, nil, nil, nil, 1, 8, nil, nil, "watchfeet")
