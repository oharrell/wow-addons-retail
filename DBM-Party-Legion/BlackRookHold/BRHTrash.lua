...
local specWarnSicBats				= mod:NewSpecialWarningYou(203163, nil, nil, nil, 1, 2, nil, nil, "targetyou")
local specWarnStrikeDown			= mod:NewSpecialWarningDefensive(225732, nil, nil, nil, 1, 2, nil, nil, "defensive")
local specWarnCoupdeGrace			= mod:NewSpecialWarningDefensive(214003, nil, nil, nil, 1, 2, nil, nil, "defensive")
local specWarnBrutalAssault			= mod:NewSpecialWarningDefensive(201139, nil, nil, nil, 1, 2, nil, nil, "defensive")
local specWarnBonebreakingStrike	= mod:NewSpecialWarningDodge(200261, nil, nil, nil, 2, 2, nil, nil, "shockwave")--Even tank can side step it, but tank can also aim it away from others
local specWarnWhirlOfFlame			= mod:NewSpecialWarningDodge(221634, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnIndigestion			= mod:NewSpecialWarningDodge(200913, nil, nil, nil, 2, 2, nil, nil, "shockwave")
local specWarnThrowArtifact			= mod:NewSpecialWarningDodge(201176, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnRavensDive			= mod:NewSpecialWarningDodge(214001, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnOverDetonation		= mod:NewSpecialWarningRun(221688, nil, nil, nil, 4, 2, nil, nil, "justrun")
local specWarnSoulEchos				= mod:NewSpecialWarningMoveAway(194966, nil, nil, nil, 1, 2, nil, nil, "runout")
local yellArrowBarrage				= mod:NewYell(200343)
local specWarnSpiritBlast			= mod:NewSpecialWarningInterrupt(196883, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnDarkMending			= mod:NewSpecialWarningInterrupt(225573, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnSoulBlast				= mod:NewSpecialWarningInterrupt(199663, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnArcaneBlitz			= mod:NewSpecialWarningInterrupt(200248, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnFelFrenzy				= mod:NewSpecialWarningInterrupt(227913, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Priority
local specWarnSoulBlade				= mod:NewSpecialWarningDispel(200084, "RemoveMagic", nil, nil, 1, 2, nil, nil, "helpdispel")
local specWarnDrainLife				= mod:NewSpecialWarningDispel(204896, "RemoveMagic", nil, nil, 1, 2, nil, nil, "helpdispel")
local specWarnEnrage				= mod:NewSpecialWarningDispel(8599, "RemoveEnrage", nil, 2, 1, 2, nil, nil, "enrage")
