...
local specWarnPropellingCharge		= mod:NewSpecialWarningDodge(200768, nil, nil, nil, 2, 2, nil, nil, "chargemove")
local specWarnRootBurst				= mod:NewSpecialWarningDodge(201129, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnVileMushroom			= mod:NewSpecialWarningDodge(198910, nil, nil, nil, 2, 2, nil, nil, "watchstep")
local specWarnDreadInfernoFailed	= mod:NewSpecialWarningMoveAway(201399, nil, nil, nil, 1, 2, nil, nil, "runout")
local yellDreadInferno				= mod:NewYell(201399)
local specWarnBloodAssault			= mod:NewSpecialWarningDefensive(201226, nil, nil, nil, 1, 2, nil, nil, "carefly")
local specWarnUnnervingScreech		= mod:NewSpecialWarningInterrupt(200630, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Priority
local specWarnDespair				= mod:NewSpecialWarningInterrupt(200642, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnTormentingEye			= mod:NewSpecialWarningInterrupt(204243, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Priority
local specWarnBloodMeta				= mod:NewSpecialWarningInterrupt(225562, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Priority
local specWarnDreadInferno			= mod:NewSpecialWarningInterrupt(201399, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")--High Priority
local specWarnCurseofIsolation		= mod:NewSpecialWarningInterrupt(201839, "HasInterrupt", nil, nil, 1, 2, nil, nil, "kickcast")
local specWarnPoisonSpear			= mod:NewSpecialWarningDispel(198904, "RemovePoison", nil, nil, 1, 2, nil, nil, "helpdispel")
local specWarnTormentingFear		= mod:NewSpecialWarningDispel(204246, "RemoveMagic", nil, nil, 1, 2, nil, nil, "helpdispel")--Missed eye interrupt
local specWarnCurseofIsoDispel		= mod:NewSpecialWarningDispel(201839, "RemoveCurse", nil, nil, 1, 2, nil, nil, "helpdispel")--Missed Taintheart interrupt
local specWarnDarksoulDrain			= mod:NewSpecialWarningDispel(201365, "RemoveDisease", nil, nil, 1, 2, nil, nil, "helpdispel")
